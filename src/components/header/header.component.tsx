  ...
  return (
    <header className="flex justify-between items-center">
      ...
      <ul className="flex gap-8">
        ...
        <li className="font-semibold text-[#808080]">Why Food?</li>
        <li className="font-semibold text-[#808080]">Menu</li>
        <li className="font-semibold text-[#808080]">Location</li>
      </ul>

      <div className="flex gap-4">
        <FaSistrix className="text-xl text-[#808080]" />
        <FaBars className="text-xl text-[#808080]" />
      </div>
    </header>
  );
};
